...
import type { IEnderecoRespository } from "../ports/EnderecoRepository";
import type { IRegisterEnderecoUC } from "../ports/RegisterEnderecoUC";
...
export class RegisterEndereco implements IRegisterEnderecoUC {
    ...
    async registerEndereco (enderecoDados: EnderecoDados): Promise<RegisterEnderecoDTO>{
        ...
        if (enderecoExists) {
            ...
            await this._enderecoRepo.add(endereco.value);
        }
